...
const isElementInArray = (searchElement, inputArray) => {
  if (typeof searchElement !== "object") {
    return inputArray.includes(searchElement); // daca cautam obiect in masiv, includes ne va returna fals, el identifica doar valorile primitive
  }
  const searchString = JSON.stringify(searchElement);
  return inputArray.some((element) => JSON.stringify(element) === searchString);
};
