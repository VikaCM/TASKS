...
//   return `Число ${myNumber}. Это число ${
//     myNumber < 10
...
// const templateLiteral1 = (num) => {
//   return `Число ${myAnotherNumber}. Это число больше или равно 10.
//     Квадратный корень этого числа - ${Math.sqrt(num)}.`;
// };

// const myAnotherNumber = 25;
// console.log(templateLiteral1(myAnotherNumber));
// /*
// Число 25.
...
// const templateLiteral = (num) => {
//   return `Число ${num}. Это число ${
//     num < 10 ? `меньше` : "больше или равно"
//   } 10.  Квадратный корень этого числа -3`;
// };
// // ТЕСТ 1
// const myNumber = 9;
// console.log(templateLiteral(myNumber));
