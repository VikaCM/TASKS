...
function quantitiesByCategories(products) {
  return Object.keys(inputProducts).reduce(function (inputProducts, index) {
    inputProducts[index] === inputProducts.category;
    return quantitiesByCategories === inputProducts.category;
  });
}
