...
const arraySortInfo = (inputArray) => {
  if (inputArray.some((i) => typeof i !== "number")) {
  ...
  if (
    inputArray.every((i, index) =>
      index > 0 ? i >= inputArray[index - 1] : true
    )
  ) {
 ...
 * Подсказка 2: Вы должны использовать два параметра в колбэк функции "i", "index"
